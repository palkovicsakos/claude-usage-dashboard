  ...
  return (
    <div className="mb-5">
      ...
      <div
        ...
        style={{ height: 8, background: trackColor }}
      >
        <div
  ...
  return (
    <div>
      <HoursRow
        ...
        maxMinutes={max}
        barColor="#D97757"
        trackColor="rgba(217,119,87,0.12)"
        valueColor="#D97757"
      />
      <HoursRow
        label="Span"
        ...
        maxMinutes={max}
        barColor="#C4B5A0"
        trackColor="rgba(196,181,160,0.2)"
      />
      <HoursRow
        label="Idle"
        ...
        maxMinutes={max}
        barColor="#EDE9E4"
        trackColor="rgba(237,233,228,0.6)"
      />
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ width: 72, height: 5, background: '#F5E8E1' }}
          >
            <div
